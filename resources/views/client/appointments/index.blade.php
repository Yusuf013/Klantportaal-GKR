                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            @forelse($appointments as $appointment)
                                <tr onclick="openClientDetailModal({{ $appointment->id }})" class="hover:bg-gray-50/50 transition duration-150 group cursor-pointer" title="Klik om details te bekijken">
